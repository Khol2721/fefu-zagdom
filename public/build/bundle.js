...
var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-swiper]', {
  loop: true,
  pagination: {
...
const escapeFn = _env__WEBPACK_IMPORTED_MODULE_3__.inBrowser && window.CSS && CSS.escape || function (css) { return css.replace(/([^\x7f-\uFFFF\w-])/g, match => `\\${match}`); };
function escape(css) {
